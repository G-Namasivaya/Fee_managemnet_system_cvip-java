...
/**
 * 
 * this class is responsible for keeping the track of stundent's id, name,
 * grade,
 * Total fees of the month that should student has to pay and the fees he has
 * paid,
 * once the fees get paid it gives a message the you fees is paid successfully
 * for this month.
 *
 */
...
public class Student {
	...
	/**
	 * this is the student class argument constructor so when the object is made it
	 * can be called with the below parameters,
	...
	public String toString() {
		return "Student's Id:" + getId() + "\nStudent's Name: " + getName() + "\nStudent's Grade: " + getGrade()
				+ "\nStudent's Total fees: " + getFeesTotal() + "rs" + "\nStudent's Paid fees: " + getFeesPaid() + "rs";
	}
